...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  SegStream/a_4.  Test case 1 1'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard  SegStream/i_AGH Report Test 041521_fa fa-plus-circle'))

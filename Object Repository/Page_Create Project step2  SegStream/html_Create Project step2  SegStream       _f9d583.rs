...
<WebElementEntity>
   ...
   <name>html_Create Project step2  SegStream       _f9d583</name>
   <tag></tag>
   <elementGuidId>82c3d571-f8fa-439c-9510-2c779643f3bd</elementGuidId>
   <selectorCollection>
      <entry>
         <key>CSS</key>
         <value>html</value>
   ...
   <webElementProperties>
      ...
      <type>Main</type>
      <value>
    Create Project step2 | SegStream
...
.notification_popup .go-back-to-home{
    display: none;
                ...
                Toggle navigation
                    ...
                    Alpha
                        ...
                        Manage Custom Assembly
                            ...
                            Manage Default Purpose Description
                            Manage Purpose Description Mapping
                            Manage Location
                            Manage Custom Unit
                            Manage Cost Source
                            Manage Org Asset Class
                            Manage Default Asset Class
        ...
        $(&quot;#id_edit_building_form&quot;).on(&quot;submit&quot;, function(e){
            e.preventDefault();
            e.stopPropagation();
            ...
            data = {}
            $(&quot;.buildingmodule_count&quot;).each(function(){
                $this = $(this);
                data[&quot;value-&quot;+$(this).data(&quot;buildingmodule_id&quot;)] = $(this).val()
                data[&quot;names-&quot;+$(this).data(&quot;buildingmodule_id&quot;)] = []

                $(&quot;.building-names-&quot;+$this.data(&quot;buildingmodule_id&quot;)).each(function(){
                    data[&quot;names-&quot;+$this.data(&quot;buildingmodule_id&quot;)].push($(this).val())
                })
            })
            ...
            $.ajax({
                ...
                &quot;type&quot;: &quot;POST&quot;,
                &quot;data&quot;: {
                    &quot;csrfmiddlewaretoken&quot;: &quot;Qj2Q7PBKXJzSbVGEeV7KoT9TmR1x4GGtSq575BsIzN8Wjmwqhzjr5f369UpY1gA1&quot;,
                    &quot;data&quot;: JSON.stringify(data)
                },
                success: function(){
                    window.location.href = &quot;/project/update-enhanced-property/2833/&quot;
                }
            })

        })

        $(&quot;.should_take_name&quot;).on(&quot;change&quot;, function(e){
            current_no = $(&quot;.building-names-&quot;+$(this).data(&quot;buildingmodule_id&quot;)).length || 0;

            if($(this).val()){
                new_no = parseInt($(this).val());
                ...
                dif = new_no - current_no;

                if(dif&lt;0){
                    $(&quot;.building-names-&quot;+$(this).data(&quot;buildingmodule_id&quot;)).slice(dif).each(function(){
                        $(this).remove();
                    })
                }else{
                    count = 0;
                    while(count &lt; dif){
                        $(&quot;.building-names-box-&quot;+$(this).data(&quot;buildingmodule_id&quot;)).append('&lt;input type=&quot;text&quot; class=&quot;form-control building-names-'+$(this).data(&quot;buildingmodule_id&quot;)+'&quot; required=&quot;required&quot; style=&quot;margin:5;&quot;>')
                        count++;
                    }
                }

                if(new_no&lt;=0){
                    $(&quot;.building-names-container-&quot;+$(this).data(&quot;buildingmodule_id&quot;)).hide();
                }else{
                    $(&quot;.building-names-container-&quot;+$(this).data(&quot;buildingmodule_id&quot;)).show();
                }
            }else{
                $(this).val(current_no)
                e.preventDefault();
    ...
    $(document).ready(function(){
        ...
        $(document).on('change', '#id_purpose_description', function(){
            ...
            if (check &amp;&amp; value &amp;&amp; value != &quot;Others&quot;){
                ...
                Are you sure you want to delete the filtered records?
    ...
    function uploadCostFile(id, type){
        ...
        formdata.append('csrfmiddlewaretoken', 'Qj2Q7PBKXJzSbVGEeV7KoT9TmR1x4GGtSq575BsIzN8Wjmwqhzjr5f369UpY1gA1');
    ...
    function revert_items_cost_and_reopen(){
        revert_ajax_request(&quot;/project/revert-cost-factors/&quot;, function(response){
            window.location.href = window.location.href.split(&quot;?&quot;)[0] + '?page=&amp;selected_ids=' + selectedIndex.join(',');
        })
    }
    ...
    var notification_manager;
     ...
     $(document).ready(function(){
        ...
        $('.import_cost_setup').on('click', function(e){
            ...
            $('#upload_cost_setup').attr('onclick', 'uploadCostFile(&quot;2833&quot;, &quot;'+type+'&quot;)');
    ...
    function onMessage (evt) {
        ...
        if(data.type == 'notification'){
            ...
            var notification_property_id = 2833;
    ...
    $(document).on(&quot;click&quot;, &quot;.prev_items_with_assemblies&quot;, function(e){
        ...
        if($(this).data('check_url') == 'custom'){
            ...
            update_cus_item_details($('#id_cus_additem_form'));
        }else{
